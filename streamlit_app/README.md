...
| --- | --- | --- |
| **Status** | **Works today.** The route described below. | **Works today.** [Download the `.dmg` or the `.exe`](https://github.com/zhanyinx/variantalker/releases/tag/mafigate-v1.0.0) — both are built by CI from one commit, and the release page states what your machine needs before you spend the download. |
