...
The variants have been annotated and prioritized using [variantalker](https://github.com/zhanyinx/variantalker)
...
For more info on how these filters are applied, see the pipeline's [filter documentation](https://github.com/zhanyinx/variantalker#default-filters), which describes the current version of the pipeline; the filters applied to this report are the ones listed above.
